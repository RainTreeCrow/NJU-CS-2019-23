    ...
    if n == 0:
        ...
        def combiner_term(x):
            if x == 1:
                ...
                return combiner(combiner_term(x-1), term(x))
        return combiner(base, combiner_term(n))
...
def count_change(amount):
    ...
    True
    """
    def count_part(amount, change):
        if amount == 0:
            return 1
        elif change > amount:
            return 0
        else:
            with_change = count_part(amount - change, change)
            wo_change = count_part(amount, change * 2)
